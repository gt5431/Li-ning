...
<body>
	...
	<div id="member">
		<div id="menber_top_left">
			<img src="../images/member_center_icon.png">
		</div>
		...
		<div id="member_content">
			...
			<div id="membber_email" class="second">
				<label class="roew_style">邮箱：</label> <label id="login_email"
					style="color: #0F0">675436321@qq.com</label>
			</div>
			...
			<div id="membber_button" class="second" style="display: inline;">
				<input type="button" value="提交修改" id="mbutton" class="mbutton" /> <input
					type="button" value="返回主页" id="mbutton" class="mbutton" />
			</div>
		</div>
	</div>
