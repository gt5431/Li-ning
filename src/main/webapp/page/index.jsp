				...
				<div id="whole" style="display: none;">
					...
					<div id="bg_content">
						...
						<div id="forth">
							...
							<img src=" images/yanzhma.jpg" class="tp"> <span class="yzM">请输入验证码</span>
						</div>
						<div id="five">
				...
				<div id="zhuce" style="display: none;">
					...
					<div id="yuedu">
						<input type="checkbox" style="vertical-align: middle;"
							name="yuedu" checked="" class="yuedu"> <span class="sure">我已阅读《<a
			...
			<div class="hotcake">
				<div class="hchoice">
				   <c:forEach items="${sessionScope.Type}" var="type">
					<div id="chioce_1${type.typesid}" class="choice_Item" onmouseover="findProductById('${type.typesid}')" onmouseout="mouseout('${type.typesid}')">
						         ...
						         <div class="selItem">
		                            	<div class="selMainPic">
		                                    ...
		                                    <div class="slaveSwiperContent">
		                                    	<div class="slaveItem"><img  src="${product.color.split(',')[0]}"/><font></font></div>
		                                        <div class="slaveItem"><img  src="${product.color.split(',')[1]}"/><font></font></div>
					...
					<div class="Run_main">
						...
						<div class="run_list">
							<div class="run_list_content" id="run_list_content"
								...
								<ul>
	                                <li style="font-family:\'Microsoft YaHei UI\';">
		                            ...
		                            <li style="font-family:\'Microsoft YaHei UI\';">
		                            <a href="shoppingcart.jsp">
		                            <img src="images/Wcloths_2.png" />
		                            <span style="font-family:\'Microsoft YaHei UI\';">
								  	<font class="rl_name">【2015新品】李宁</font>
									<font class="rl_category">ARBK097-1</font>
									</span>
		                            <em>
		                            <font class="ft_14" sku="AWYK001-3">¥ 112</font>
		                            </em>
		                            </a>
		                            </li>
		                             <li style="font-family:\'Microsoft YaHei UI\';">
		                            <a href="shoppingcart.jsp">
		                            <img src="images/Wcloths_1.png" />
		                            <span style="font-family:\'Microsoft YaHei UI\';">
								  	<font class="rl_name">【2015新品】李宁</font>
									<font class="rl_category">ARBK097-1</font>
									</span>
		                            ...
		                            <font class="ft_14" sku="AWYK001-3">¥ 112</font>
		                             ...
		                             <li style="font-family:\'Microsoft YaHei UI\';">
		                            <a href="shoppingcart.jsp">
		                            <img src="images/goods_5.png" />
		                            <span style="font-family:\'Microsoft YaHei UI\';">
								  	<font class="rl_name">【2015新品】李宁</font>
									<font class="rl_category">ARBK097-1</font>
									</span>
		                            <em>
		                            <font class="ft_14" sku="AWYK001-3">¥ 162</font>
		                            </em>
		                            </a>
		                            </li>
		                             <li style="font-family:\'Microsoft YaHei UI\';">
