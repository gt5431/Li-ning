	...
	$(function(){
		...
		var buyNum = $("#quantity_306687").val();//当前购买数量
			$.ajax({
					type: "POST",
	   				url: "goods.do",
	   				data:"oop=addNum&pid="+pNum+"&num="+buyNum,
...
<!-----------------------------------头部开始(2015-11-20)---------------------------------------->
    ...
    <div id="center">
        ...
        <div id="number">
	        <p>我要买：</p>
	        <a class="reduce" href="javascript:void(0)" onclick="goods_buy(-1);" style="font-family: 微软雅黑;">-</a>
...
<div id="main">
	<div id="find">
    	<div id="f1" style="cursor:pointer; font-family:微软雅黑;">查看所有分类</div>
        	...
        	<div id="f2" style="cursor:pointer; font-family:微软雅黑;">男鞋</div></li>
            <div id="f3">
            	<a href="">篮球鞋</a>
                <a href="">跑步鞋</a>
                <a href="">网球鞋</a>
            ...
            <div id="f2" style="cursor:pointer; font-family:微软雅黑;">女鞋</div></li>
            <div id="f3">
            	<a href="">篮球鞋</a>
                <a href="">跑步鞋</a>
                <a href="">网球鞋</a>
            ...
            <div id="f2" style="cursor:pointer; font-family:微软雅黑;">男装</div></li>
            <div id="f3">
            	<a href="">T恤</a>
                <a href="">比赛服</a>
                <a href="">卫衣</a>
            ...
            <div id="f2" style="cursor:pointer; font-family:微软雅黑;">女装</div></li>
            <div id="f3">
            	<a href="">T恤</a>
                <a href="">比赛服</a>
                <a href="">卫衣</a>
     ...
     <div id="info">
        ...
        <div id="info3" style="display:none">
        	<table id="table" width="740px;" style="margin-left:20px;">
            	<tbody>
                	<tr>
                    	<td id="td_left"><div><p> 鞋子很好，鞋底软，穿着舒服，就是在跑步机跑有种像疼不像疼应该是累的感觉，不知为何，穿其他鞋没试过这样的，但穿着走路舒服 </p></div></td>
                        <td id="td_right">
                        	<div>颜色分类：黑</div>
                        </td>
                        <td id="td_right">
