			...
			<div id="navigation_left">
				...
				<c:choose>
					<c:when test="${sessionScope.usersinfo.username != null}">
						 ...
						 <a id="loginout" href="user_loginout.action">注销</a>
					</c:when>
					<c:otherwise>
	...
	line-height: 20px;
		...
		<div id="content" style="display: block;">
			...
			<div id="r_view_hide"
				...
				<c:forEach items="${sessionScope.collection}" var="option">
				   		<div id="liulan" style="width:80%; height:106px; float:left; margin-top:10px;">
		                	<a href="goodsinfo_FindGoods.action?pro_number=${option.pro_number}"><img src="../${option.color.split(",")[0]}" 
		                		style="width:90px; height:90px; margin-left:50px;" /></a>
		                	<p style="color:#FFF; margin-left:40px; margin-top:0px">￥${option.pro_price }</p>
		                </div> 	
				</c:forEach> 
