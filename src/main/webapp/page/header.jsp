...
$("#loginout").click(function(){
	...
	<div id="content" style="display: block;">
			...
			<div id="zhuce" style="display: none;">
				...
				<div id="yuedu">
					<input type="checkbox" style="vertical-align: middle;" name="yuedu"
						checked="checked" class="yuedu"> <span class="sure">我已阅读《<a
		...
		<div id="r_view_hide"
			...
			<c:forEach items="${sessionScope.collection }" var="coll">
				<div id="liulan" style="width: 75%; height: 106px; float: left; margin-top:10px;">
					<a href="pro_details.action?pro_number=${coll.pro_number}"><img src='../${coll.pro_img.split(",")[0]}' style="width:90px; height:90px; margin-left:50px;"></a>
					<p style="color:#FFF; margin-left:50px;">￥${coll.pro_tagprice }</p>
				</div>
			</c:forEach>
		</div>
