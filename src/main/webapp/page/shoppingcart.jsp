...
<body>
	...
	<div id="shopincart_content">
		...
		<div id="container" style="padding-bottom: 10px; font-family: 微软雅黑;">
			<div class="items clearfix">
				<table cellspacing="0" cellpadding="0" class="grid">
					<thead
						...
						<tr>
							<td width="50"><input type="checkbox" id="chkAll" onclick="selectAll(this.checked)"
					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach items="${sessionScope.cartList}" var="product">
								<tr>
									<td><input type="checkbox" id="chkGoods" name="chkGoods" onclick="ch()" value="${product.pro_number}"/></td>
									...
									<td>
										<a class="reduce" href="javascript:void(0)" onclick="goods_buy(-1)">-</a> 
										<input id="quantity_306687" class="quantity" value="${product.getBuyamount()}"
												style="top:0;text-align:center;width:30px;" /> 
										<a class="add" href="javascript:void(0)" onclick="goods_buy(1)">+</a>
									</td>
									<td>¥0.00</td>
									...
									<td>
										...
										<div class="relative">
											<a style="text-decoration: none;" class="line"
												href="javascript:void(0)" onclick="deleteById(${product.pro_number})">删除</a>
					...
					<tfoot style="background: rgb(239, 239, 239);">
						<tr>
							<td style="text-align: center; height: 52px;">
								<input type="checkbox" style="vertical-align: middle;" onclick="selectAllbutton(this.checked)"
								id="chkAll_bottom" name="chkAll_bottom" /></td>
							<td style="text-align: left;">全选</td>
							<td>
								<span style="color: #CC0000;">X</span> 
								<a style="color: #555555;" href="javascript:void(0);" onclick="deleteBySel()">删除选中商品</a>
							</td>
							<td colspan="2">&nbsp;</td>
			...
			<form style="float: right; margin-top: -30px;" id="orderMyform"
				method="POST">
